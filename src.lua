...
local function createTween(object, duration, properties, easing)
	easing = easing or Enum.EasingStyle.Quint
	local info = TweenInfo.new(duration, easing, Enum.EasingDirection.InOut)
	...
	function InsideFuzki:CreateSection(tab)
		...
		tabButton.MouseButton1Click:Connect(function()
			for i, v in next, elementFolder:GetChildren() do
				createTween(v, 0.2, {BackgroundTransparency = 1}):Play()
				game:GetService("Debris"):AddItem(v, 0.2)
			end
			for i, v in next, tabFrame:GetChildren() do
				if v:IsA("TextButton") then
					createTween(v, 0.15, {BackgroundColor3 = Color3.fromRGB(52, 52, 52)}):Play()
				end
			end
			createTween(tabButton, 0.15, {BackgroundColor3 = Color3.fromRGB(40, 40, 40)}):Play()
			wait(0.05)
			for i, v in next, elementFolder:GetChildren() do
				v.Visible = false
			end
			elementContainer.Visible = true
			createTween(elementContainer, 0.25, {BackgroundTransparency = 0}):Play()
		end)
		...
		function Items:CreateButton(text, info, callback)
			...
			TextButton.MouseEnter:Connect(function()
				createTween(TextButton, 0.1, {BackgroundColor3 = Color3.fromRGB(50, 50, 50)}):Play()
			end)
			TextButton.MouseLeave:Connect(function()
				createTween(TextButton, 0.1, {BackgroundColor3 = Color3.fromRGB(30, 30, 30)}):Play()
			end)
			TextButton.MouseButton1Click:Connect(function()
				createTween(TextButton, 0.08, {BackgroundColor3 = Color3.fromRGB(20, 20, 20)}):Play()
				callback()
				game:GetService("Debris"):AddItem(TextButton.Parent, 0.5)
			end)
		end
		...
		function Items:CreateToggle(info, callback)
			...
			toggleBtn.MouseEnter:Connect(function()
				createTween(toggleBtn, 0.1, {BackgroundColor3 = Color3.fromRGB(45, 45, 45)}):Play()
			end)
			toggleBtn.MouseLeave:Connect(function()
				local targetColor = tog and Color3.fromRGB(30, 30, 30) or Color3.fromRGB(40, 40, 40)
				createTween(toggleBtn, 0.1, {BackgroundColor3 = targetColor}):Play()
			end)
			toggleBtn.MouseButton1Click:Connect(function()
				tog = not tog
				callback(tog)
				local targetColor = tog and Color3.fromRGB(30, 30, 30) or Color3.fromRGB(40, 40, 40)
				createTween(toggleBtn, 0.2, {BackgroundColor3 = targetColor}):Play()
			end)
		end
		...
		function Items:CreateBind(info, first, callback)
			...
			keybindBtn.MouseEnter:Connect(function()
				createTween(keybindBtn, 0.1, {BackgroundColor3 = Color3.fromRGB(45, 45, 45)}):Play()
			end)
			keybindBtn.MouseLeave:Connect(function()
				createTween(keybindBtn, 0.1, {BackgroundColor3 = Color3.fromRGB(30, 30, 30)}):Play()
			end)
			keybindBtn.MouseButton1Click:Connect(function()
				createTween(keybindBtn, 0.1, {TextColor3 = Color3.fromRGB(100, 100, 100)}):Play()
				keybindBtn.Text = "..."
				...
				createTween(keybindBtn, 0.1, {TextColor3 = Color3.fromRGB(212, 212, 212)}):Play()
			end)
		...
		function Items:CreateTextBox(info, placeholder, callback)
			...
			TextBox.Focused:Connect(function()
				createTween(textBoxout, 0.15, {BackgroundColor3 = Color3.fromRGB(45, 45, 45)}):Play()
			end)
			TextBox.FocusLost:Connect(function(EnterPressed)
				createTween(textBoxout, 0.15, {BackgroundColor3 = Color3.fromRGB(30, 30, 30)}):Play()
		...
		function Items:CreateSlider(minvalue, maxvalue, info, callback)
			...
			sliderBtn.MouseButton1Down:Connect(function()
				createTween(sliderBtn, 0.1, {BackgroundColor3 = Color3.fromRGB(50, 50, 50)}):Play()
				...
				releaseconnection = uis.InputEnded:Connect(function(Mouse)
					if Mouse.UserInputType == Enum.UserInputType.MouseButton1 then
						...
						Frame.Size = UDim2.new(0, math.clamp(mouse.X - Frame.AbsolutePosition.X, 0, 128), 0, 10)
						createTween(sliderBtn, 0.1, {BackgroundColor3 = Color3.fromRGB(30, 30, 30)}):Play()
			...
			sliderBtn.MouseEnter:Connect(function()
				if not moveconnection then
					createTween(sliderBtn, 0.1, {BackgroundColor3 = Color3.fromRGB(45, 45, 45)}):Play()
				end
			end)
